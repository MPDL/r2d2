 ...
 * A singleton container is started only once when the base class is loaded. The container can then
 * be used by all inheriting test classes. At the end of the test suite the Ryuk container that is
